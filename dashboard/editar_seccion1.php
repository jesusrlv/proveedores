...
<!-- consulta -->
      <?php
        ...
        $personas_fisicas = "SELECT * FROM datos WHERE id_ext = $id";
        $resultado_fisica= $conn->query($personas_fisicas);
        $row_fisica = $resultado_fisica->fetch_assoc();
        ...
        <div class="row">
            ...
            <form action="prcd/editar_secciones/proceso_seccion_1.php" class="needs-validation" method="POST">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="apellido" name="apellido" placeholder="" value="<?php echo $row_fisica['fisc_apellido'] ?>" required>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="nombre" name="nombre" placeholder="" value="<?php echo $row_fisica['fisc_nombre'] ?>" required>
                    <div class="invalid-feedback">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="curp" name="curp" placeholder="" value="<?php echo $row_fisica['fisc_curp'] ?>" required>
                    <div class="invalid-feedback">
                    Valid first name is required.
                    </div>
                </div>
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="rfc" name="rfc" placeholder="" value="<?php echo $row_fisica['rfc'] ?>" required>
                    <div class="invalid-feedback">
                    Valid last name is required.
                    </div>
                </div>
