...
$direccion = "SELECT * FROM direccion WHERE id_ext = $id";
$resultado_direccion= $conn->query($direccion);
$row_direccion = $resultado_direccion->fetch_assoc();
...
?>
        ...
        <div class="row">
            ...
            <form class="needs-validation" action="prcd/editar_secciones/proceso_seccion_2.php" method="POST">
                <div class="row">
                <div class="col-md-6 mb-3">
                    <label for="firstName">Colonia</label>
                    <input type="text" class="form-control" id="colonia" name="colonia" placeholder="" value="<?php echo $row_direccion['colonia']?>" required>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="cp" name="cp" placeholder="" value="<?php echo $row_direccion['cp']?>" required>
                    <div class="invalid-feedback">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="num_int" name="num_int" placeholder="" value="<?php echo $row_direccion['n_int']?>" required>
                    <div class="invalid-feedback">
                    Valid first name is required.
                    </div>
                </div>
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="num_ext" name="num_ext" placeholder="" value="<?php echo $row_direccion['n_ext']?>" required>
                    <div class="invalid-feedback">
                    Valid last name is required.
                    </div>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="email" class="form-control" id="email" name="email" placeholder="" value="<?php echo $row_direccion['email']?>" required>
                    <div class="invalid-feedback">
                    Valid last name is required.
                    </div>
                </div>
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="tel_of" name="tel_of" placeholder="" value="<?php echo $row_direccion['tel_of']?>" required>
                    <div class="invalid-feedback">
                    Valid last name is required.
                    </div>
                </div>
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="tel_cel" name="tel_cel" placeholder="" value="<?php echo $row_direccion['tel_cel']?>" required>
                    <div class="invalid-feedback">
                    Valid last name is required.
                    </div>
                </div>
                ...
                <p><button class="btn btn-primary btn-lg btn-block" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="bi bi-check-square-fill"></i> Actualizar Sección 2</button></p>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                      <div class="modal-content">
                        ...
                        <div class="modal-body text-center">
                          <strong>Vas a actualizar la Sección 2, ¿quieres continuar?</strong>
                        </div>
