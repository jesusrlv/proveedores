            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover text-center">
                ...
                <tr class="align-middle">
                  <td>1</td>
                  <td>RCB-1</td>
                  <td><a href="<? echo $row_documentos1['ruta'] ?>" target="_blank"><i class="bi bi-eye-fill h3"></i></a></td>
...
function abortHandler(event) {
  _("status").innerHTML = "Fallo en la subida";
    ...
    <!-- <div class="progress" id="progressBar2" style="height: 20px;">
...
function abortHandler2(event) {
  _("status2").innerHTML = "Fallo en la subida";
                  ...
                  <progress id="progressBar2" value="0" max="100" style="width:81%;"></progress>
                  <h3 id="status2"></h4>
...
<!--                  <td><span class="label label-warning">Pending</span></td>-->
                ...
                <tr>
                  ...
                  <td><a href="<? echo $row_documentos3['ruta'] ?>" target="_blank"><i class="bi bi-eye-fill h3"></i></a></td>
                  <script type="text/javascript">
...
function abortHandler3(event) {
  _("status3").innerHTML = "Fallo en la subida";
                  ...
                  <progress id="progressBar3" value="0" max="100" style="width:81%;"></progress>
                  <h3 id="status3"></h4>
    ...
    ?>
            ...
            // }
                ...
                <tr>
                  ...
                  <td><a href="<? echo $row_documentos4['ruta'] ?>" target="_blank"><i class="bi bi-eye-fill h3"></i></a></td>
                  <script type="text/javascript">
...
function abortHandler4(event) {
  _("status4").innerHTML = "Fallo en la subida";
                  ...
                  <progress id="progressBar4" value="0" max="100" style="width:81%;"></progress>
                  <h3 id="status4"></h4>
    ...
    ?>
            ...
            // }
                ...
                <tr>
                  ...
                  <td><a href="<? echo $row_documentos5['ruta'] ?>" target="_blank"><i class="bi bi-eye-fill h3"></i></a></td>
                  <script type="text/javascript">
...
function abortHandler5(event) {
  _("status5").innerHTML = "Fallo en la subida";
                  ...
                  <progress id="progressBar5" value="0" max="100" style="width:81%;"></progress>
                  <h3 id="status5"></h4>
    ...
    ?>
            ...
            // }
                ...
                <tr>
                  <td>6</td>
                  <td>INE</td>
                  <td><a href="<? echo $row_documentos6['ruta'] ?>" target="_blank"><i class="bi bi-eye-fill h3"></i></a></td>
                  <script type="text/javascript">
...
function abortHandler6(event) {
  _("status6").innerHTML = "Fallo en la subida";
                  ...
                  <progress id="progressBar6" value="0" max="100" style="width:81%;"></progress>
                  <h3 id="status6"></h4>
...
function abortHandler7(event) {
  _("status7").innerHTML = "Fallo en la subida";
                  ...
                  <progress id="progressBar7" value="0" max="100" style="width:81%;"></progress>
                  <h3 id="status7"></h4>
...
function abortHandler8(event) {
  _("status8").innerHTML = "Fallo en la subida";
                  ...
                  <progress id="progressBar8" value="0" max="100" style="width:81%;"></progress>
                  <h3 id="status8"></h4>
