...
if(move_uploaded_file($_FILES["file3"]["tmp_name"],"../archivos/". $link .'_'. $codigo .'_'.$_FILES['file3']['name'])){
    echo "$fileName carga completa";
    
    $ruta_pptx = "archivos/". $link .'_'. $codigo .'_'.$_FILES['file3']['name'];
    include('../../../conn/conexion.php');
    $sqlinsert= "UPDATE archivos SET link3='$ruta_pptx' WHERE id_usr='$curp'";
