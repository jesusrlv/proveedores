...
if(move_uploaded_file($_FILES["file4"]["tmp_name"],"../archivos/". $link .'_'. $codigo .'_'.$_FILES['file4']['name'])){
    echo "$fileName carga completa";
    
    $ruta_pptx = "archivos/". $link .'_'. $codigo .'_'.$_FILES['file4']['name'];
    include('../../../conn/conexion.php');
    $sqlinsert= "UPDATE archivos SET link4='$ruta_pptx' WHERE id_usr='$curp'";
