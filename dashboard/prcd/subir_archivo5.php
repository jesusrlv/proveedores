...
if(move_uploaded_file($_FILES["file5"]["tmp_name"],"../archivos/". $link .'_'. $codigo .'_'.$_FILES['file5']['name'])){
    echo "$fileName carga completa";
    
    $ruta_pptx = "archivos/". $link .'_'. $codigo .'_'.$_FILES['file5']['name'];
    include('../../../conn/conexion.php');
    $sqlinsert= "UPDATE archivos SET link5='$ruta_pptx' WHERE id_usr='$curp'";
